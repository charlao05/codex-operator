...
class TestIntegration:
    ...
    def test_workflow_completo_leads(self):
        ...
        quentes = [
            r for r in sucessos if r["qualificacao"].get("classificacao") == "Quente"
        ]
        assert len(quentes) > 0  # Deve haver pelo menos alguma classificacao Quente
