...
from src.core.agent_queue import TaskPriority, create_deadline
...
class TestQueueCommands:
    ...
    def test_handle_queue_process_partial(self, capsys):
        ...
        for i in range(5):
            queue.push(TaskPriority.MEDIUM, deadline, 1, f"agent_{i}", f"client_{i}", {})
...
class TestQueueEdgeCases:
    ...
    def test_handle_queue_process_overdue_tasks(self, capsys):
        ...
        task = queue.push(TaskPriority.MEDIUM, past_deadline, 1, "agent", "client", {})
