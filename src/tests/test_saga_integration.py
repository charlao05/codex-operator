...
class TestCompensationScenarios:
    ...
    def test_booking_failure_at_calendar_step(self, orchestrator, booking_context):
        ...
        from src.sagas.create_booking import (
            nf_api_create, email_api_send_confirmation, 
            whatsapp_api_notify, calendar_api_remove_event
        )
    ...
    def test_payment_failure_refunds_automatically(self, orchestrator, payment_context):
        ...
        from src.sagas.collect_payment import (
            stripe_charge_customer, finance_db_delete_invoice
        )
...
class TestRetryAndRecovery:
    ...
    def test_booking_retry_on_email_failure(self, orchestrator, booking_context):
        ...
        def email_flaky(ctx):
            ...
            ctx['email_message_id'] = f"MSG-{datetime.utcnow().timestamp()}"
...
class TestOrchestratorMonitoring:
    ...
    def test_multiple_executions_tracked(self, orchestrator, booking_context, payment_context):
    ...
    def test_metrics_accuracy(self, orchestrator, booking_context, payment_context):
        ...
        from src.sagas.create_booking import calendar_api_add_event
...
class TestComplexWorkflows:
    ...
    def test_booking_then_payment_workflow(self, orchestrator, booking_context, payment_context):
