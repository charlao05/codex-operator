...
1. Abra Gmail (seu account profissional)
2. Clique "Compor"
3. Cole o email abaixo (substitua [LINK] pelo link da landing)
4. Envie agora (pode usar Agendar envio para 14:30)
...
- [ ] Copiar CADA email acima
- [ ] Colar em novo email no Gmail
- [ ] Verificar o email do destinatário
- [ ] Clicar ENVIAR (ou agendar para 14:30 se preferir)
- [ ] Anotar data/hora de envio no Google Sheets
- [ ] Atualizar status em CRM: "Enviado - [DATA/HORA]"

## 📊 RASTREAMENTO

Use `email_monitoring.py` para rastrear:
- Emails abertos (esperado: 1-2 em 24h)
- Cliques no link (esperado: 1-2 em 24-48h)
- Respostas (esperado: 1-2 em 48-72h)
- Demos agendadas (esperado: 1-2 em 72h+)

---

**PRÓXIMA AÇÃO:** Enviar agora ou agendar para 14:30. Depois rodar dashboard monitoramento.
